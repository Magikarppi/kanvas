...
export const getProjectMembers =
    "SELECT users.id, users.first_name, users.last_name, users.email, users.picture FROM users INNER JOIN project_members ON users.id = project_members.user_id WHERE project_members.project_id = $1;";
